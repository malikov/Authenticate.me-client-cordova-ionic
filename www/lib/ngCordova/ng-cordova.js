...
/*
  childBrowser plugins
*/
angular.module('ngCordova.plugins.childBrowser', [])
.factory('$cordovaChildBrowser', function() {

  return {
    showWebPage: function(url, options){
      return window.plugins.ChildBrowser.showWebPage(url, options);
    },
    close: function() {
      return window.plugins.ChildBrowser.close();
    },
    openExternal: function(url, usePhoneGap) {
      return window.plugins.ChildBrowser.openExternal(url, usePhoneGap);
    },
    event: function(event, cb) {
      return window.plugins.ChildBrowser[event] = cb;
    }
  }
});
...
/*
  localStorage
*/
angular.module('ngCordova.plugins.localStorage', [])
.factory('$cordovaLocalStorage', function() {
...
angular.module('ngCordova.plugins', [
  ...
  'ngCordova.plugins.childBrowser',
  'ngCordova.plugins.localStorage'
]);
